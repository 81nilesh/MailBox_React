    ...
    try {
      ...
      if (login) {
        response = await axios.post(
          `https://mailbox-96a99-default-rtdb.firebaseio.com/users.json`,
          obj
        );
    ...
    <div className="mt-[50px] flex flex-col items-center p-8 ">
      <div className=" grid sm:grid-cols-2 sm:grid-rows-1 p-7 bg-gradient-to-r from-[#709ad4] to-[#87CEEB] ... ">
        <div className=" bg-white p-5 flex flex-col justify-evenly">
          ...
          <form
            className="  min-h-[400px] flex flex-col justify-evenly "
            action=""
            onSubmit={formSubmitHandler}>
            <p className="font-Indie text-4xl font-bold tracking-[4px]">
              {login ? "Login" : "SignUp"}
            </p>
            ...
            {!sendingReq && (
              <button className="bg-[#1F2937] rounded-md active:bg-[#586b86] duration-700 text-white text-2xl p-2 text-center">
                {login ? "login" : "signUp "}
              </button>
            )}
            {sendingReq && (
          ...
          <div
            className="text-2xl p-2 text-center font-QuickSand "
        ...
        <div className=" hidden sm:block bg-white   ">
          <img
            ...
            src="https://media.istockphoto.com/id/545240218/vector/mail-box.jpg?s=612x612&w=0&k=20&c=B8iazd49L0ser8eVnkAJAHlNZqd11iYdPQg7PEUNRoY="
            alt=""
          />
        </div>
      </div>
